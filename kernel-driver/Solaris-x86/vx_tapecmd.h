...
#ifndef _SYS_SCSI_ADAPTERS_VX_TAPECMD_H
#define	_SYS_SCSI_ADAPTERS_VX_TAPECMD_H

#pragma ident	"@(#)vx_tapecmd.h	1.1	05/06/27 SMI"
...
#define	PKT2CMD(pkt)		((struct vx_tape_cmd *)(pkt)->pkt_ha_private)
#define	CMD2PKT(sp)		((sp)->cmd_pkt)

/*
 * Per-command VX_TAPE private data
 *
...
struct vx_tape_cmd {
	...
	struct vx_tape_cmd		*cmd_forw;	/* queue link */
...
#define	CFLAG_IN_TRANSPORT	0x0004	/* in use by vx_tape driver */
...
#endif	/* _SYS_SCSI_ADAPTERS_VX_TAPECMD_H */
